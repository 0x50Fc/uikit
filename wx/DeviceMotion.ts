...
namespace wx{
     ...
     * 开始监听设备方向的变化。
     */
    export function startDeviceMotionListening(param?:startDeviceMotionListeningParam){
    }
    /**
     * 停止监听设备方向的变化。
     */
     ...
     */
    export function onDeviceMotionChange(callback:(res:onDeviceMotionChangeRes)=>any){}
     ...
     */
    interface startDeviceMotionListeningParam{
        interval?: string
    }
     ...
     */
    interface onDeviceMotionChangeRes{
        alpha	:number
        beta	:number
        gamma	:number
    }
